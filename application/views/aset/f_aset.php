...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        <div class="container">
          <a class="navbar-brand" href="#">
            <img src="<?=base_url()?>src/backend/dist/img/logo-dishub1.png" class="logo" width="50%">
          </a>
        </div>
      </nav>
    </section>
    ...
    <footer class="bg-dark text-white text-center pt-4">
      <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> <a href="#" target="_blank">Dinas Perhubungan Provinsi Sumatra Selatan</a></strong>
      <br/>
    </footer>
